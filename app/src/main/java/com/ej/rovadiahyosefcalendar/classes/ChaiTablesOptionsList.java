...
public class ChaiTablesOptionsList {
    ...
    private static void initMetropolitanAreaEretzYisroel() {
        metropolitanAreas = new String[] {"acco", "achiezer", "achisamach", "achituv", "achuzam", "aderet", "adiad",
                ...
                "Herzliah_A-kfar_smaryahu", "Herzliah_B-ramat_hasharon", "hinanit-shaked-tal_menashe", "hosen", "hoshayahu",
                "itamar", "jerusalem", "kadima", "karmei_zur", "karnei_shomron", "kazrin", "kedumim", "kerem_ben_zimrah",
                "kesalon", "keshet", "kever_schmuel_hanavi_roof", "kever_rachel-beit_lechem", "kever_rebbi_meir_baal_hanes",
